...
export const UserManagement = [
    ...
    {id:3, menuTitle:'নতুন তথ্য', icon:'infocirlceo', route:'NewInfoNavigator', routeStatus: true},
    {id:4, menuTitle:'পরিসংখ্যান', icon:'barschart', route:'StatisticsScreen', routeStatus: true}
];
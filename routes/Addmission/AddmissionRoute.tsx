...
const AddmissionStackData = [
  {id:1, name:'AdmissionHome', component:AdmissionHome, hasHeader:true, title: 'নতুন শিক্ষার্থীর তথ্য ফরম', height:60, backgroundColor: '#0B2447', fontFamily:'HindSiliguri-SemiBold', headerTintColor: '#fff'},
  {id:2, name:'ParentsAndContact', component:ParentsAndContact, hasHeader:true, title: 'নতুন শিক্ষার্থীর তথ্য ফরম', height:60, backgroundColor: '#0B2447', fontFamily:'HindSiliguri-SemiBold', headerTintColor: '#fff'},
  {id:3, name:'CheckAllDataAndSubmit', component:CheckAllDataAndSubmit, hasHeader:true, title: 'তথ্য যাচাই ও পাঠানো', height:60, backgroundColor: '#0B2447', fontFamily:'HindSiliguri-SemiBold', headerTintColor: '#fff'},
